...
const ModbusUDPResponse = require('../src/udp-response.js')
const ModbusUDPRequest = require('../src/udp-request.js')

describe('Modbus/UDP Server Response Handler Tests', function () {
  /* we are using the read coils function to test the modbus/udp specifics */
  ...
  it('should handle a valid read coils request', function () {
    ...
    const request = ModbusUDPRequest.fromBuffer(requestBuffer)
    const responseBody = ReadCoilsResponseBody.fromRequest(request.body, coils)
    const response = ModbusUDPResponse.fromRequest(request, responseBody)
