...
const UDPResponseHandler = require('../src/udp-client-response-handler.js')

describe('Modbus/UDP Client Response Handler Tests', function () {
  let handler

  beforeEach(function () {
    handler = new UDPResponseHandler()
  })
